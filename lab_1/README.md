...
1. Закодировать любой связный текст (не менее 500 символов), любым произвольным шифром простой подстановки (моноалфавитная замена) или перестановки. Для выполнения первого задания я решил использовать шифр Подстановки, а именно Шифр Виженера.
...
Номер варианта соответсвует позиции ФИО студента в списке группы по модулю 10. (0 соответсвует 10-му варианту). Мой номер варианта, занял другой студент, поэтому я решил присвоить себе его вариант.

### Результаты выполнения лабораторной работы:
Итоговый репозиторий с результатами выполненной лабораторной работы должен содержать:
- исходные коды для выполнения обоих заданий лабораторной работы (подразумевается python)(task1.py, task2.py),
- исходный шифруемый текст для задания 1(text.txt),
